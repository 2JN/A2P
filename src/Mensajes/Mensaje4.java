...
public class Mensaje4 extends javax.swing.JFrame {
int x1,y1,counts;
    /**
...
if(evt.getKeyCode()==10)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
